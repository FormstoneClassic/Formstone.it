...
!function(a){"use strict";for(var b=0,c=["webkit","moz"],d=0;d<c.length&&!a.requestAnimationFrame;d++)a.requestAnimationFrame=a[c[d]+"RequestAnimationFrame"],a.cancelAnimationFrame=a[c[d]+"CancelAnimationFrame"]||a[c[d]+"CancelRequestAnimationFrame"];a.navtiveRAF="undefined"!=typeof a.requestAnimationFrame,a.navtiveRAF||(a.requestAnimationFrame=function(c){var d=(new Date).getTime(),e=Math.max(0,16-(d-b)),f=a.setTimeout(function(){c(d+e)},e);return b=d+e,f},a.cancelAnimationFrame=function(a){clearTimeout(a)})}(this),function(a,b){"use strict";function c(){d&&(b.requestAnimationFrame(c),jQuery.fx.tick())}var d=!1;b.navtiveRAF||(a.fx.timer=function(b){b()&&a.timers.push(b)&&!d&&(d=!0,c())},a.fx.stop=function(){d=!1})}(jQuery,this);